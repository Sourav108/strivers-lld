...
/**
 * Main Simulation Driver for the Logging Framework
 * Demonstrates:
 * 1. Log Levels & Priority Filtering (DEBUG, INFO, WARNING, ERROR, FATAL)
 * 2. Strategy Pattern for Output Destinations (ConsoleAppender, FileAppender)
 * 3. Strategy Pattern for Layout Formatting (SimpleFormatter, DetailedFormatter)
 * 4. Chain of Responsibility for Filtering (LevelFilter, SourceFilter)
...
public class Main {
    public static void main(String[] args) throws InterruptedException {
        System.out.println("=================================================================");
        System.out.println("🪵 LOGGING FRAMEWORK - INTERVIEW LLD DEMONSTRATION");
        System.out.println("=================================================================");
        ...
        Logger paymentLogger = Logger.getLogger("PaymentGateway");
        ...
        // =========================================================================
        // SCENARIO 3: MULTIPLE APPENDERS (Console + File)
        // =========================================================================
        System.out.println("\n-----------------------------------------------------------");
        System.out.println("3️⃣ SCENARIO 3: Multiple Output Destinations (Console + File)");
        System.out.println("-----------------------------------------------------------");

        Logger multiLogger = Logger.getLogger("UserAuthService");
        ...
        System.out.println("📡 Logging message to BOTH Console and FileAppender (" + logFilePath + ")...");
        multiLogger.warning("User 'john_doe' failed 3 login attempts", "UserAuthService.authenticate");
        multiLogger.info("User 'john_doe' password reset email sent"); // Only goes to Console (File is WARNING+)
        ...
        Logger filteredLogger = Logger.getLogger("AuditLogger");
        ...
        filteredLogger.info("Allowed audit record", "com.takeuforward.security.AuditService"); // Allowed
        filteredLogger.info("Blocked third-party spam", "org.external.thirdparty.Tracker");    // Blocked by filter!
        ...
        Logger concurrentLogger = Logger.getLogger("ConcurrentEngine");
